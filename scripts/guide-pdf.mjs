...
const PAGES = [
  ['docs/guide.html', 'release/Lumika-guide-fr.pdf'],
  ['docs/en/guide.html', 'release/Lumika-guide-en.pdf']
]
...
const STYLE_PDF = `
  ...
  .hero { padding-top: 0; }
  .grad-text { color: #A8154F !important; -webkit-text-fill-color: #A8154F !important; }
  .piege { border-left: 3px solid #A8154F; color: #333; }
`
