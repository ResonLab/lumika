...
fabriquer(
  ...
  'fr',
  "Lumika — conditions d'utilisation",
  "Les conditions d'utilisation d'Lumika : ce que le calcul et le conseil de placement font, et ce qu'ils ne font pas."
)
fabriquer(
  conditions,
  'docs/en/index.html',
  ...
  'en',
  'Lumika — terms of use',
  'The terms of use of Lumika: what the channel allocation does, and what it does not do.'
)
