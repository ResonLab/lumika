...
function fabriquer(guide, source, cible, langue, titre, description) {
  ...
  for (const ancre of ['#ce-quelle-fait', '#honnetete', '#principes']) {
...
fabriquer(
  ...
  'docs/guide.html',
  'fr',
  'Lumika — par où commencer',
  'Le guide de prise en main de Lumika : inventaire, perches, blocs de gradateurs, plan de feu, vérification. Dans cet ordre, et pourquoi.'
)
fabriquer(
  guide,
  'docs/en/index.html',
  'docs/en/guide.html',
  'en',
  'Lumika — where to start',
  'Getting started with Lumika: inventory, bars, dimmer racks, lighting plan, check. In that order, and why.'
)
