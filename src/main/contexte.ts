 ...
 * n'importe jamais Electron** : c'est la règle de la maison, et c'est elle qui
 * garde la logique métier éprouvable sans lancer de fenêtre.
 */
interface Contexte {
...
export function cheminBase(): string {
  return join(dossierDonnees(), 'lumika.sqlite')
}
