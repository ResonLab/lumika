 ...
 */
const essentiels = [
  ['sa distance est donc négative', pageFr, 'français'],
  ['distance is therefore negative', pageEn, 'anglais'],
  ['autant de canaux DMX', pageFr, 'français'],
  ['as many DMX channels as it has circuits', pageEn, 'anglais'],
  ['pas « alerte dès que', pageFr, 'français'],
  ['not "alert as soon as', pageEn, 'anglais']
]
...
const ordreAttendu = ['inventaire', 'perches', 'gradateurs', 'plan de feu', 'imprimer']
